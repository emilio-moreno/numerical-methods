...
def main():
    ...
    for x0 in range(-10, 11, 2):
        tiempos, valores_x, valores_y = runge_kutta(t_0 = -10, t_f = 2.5, N = 1000, x_0 = x0, y_0 = 0, f = Airy)
        ax.plot(tiempos, valores_x)
    ...
    plt.savefig('Airy/multi_airy_rk.jpg')
